...
class SnakeGame:
    ...
    def _make_grid(self):
        for i in range(0, self.w, BLOCK_SIZE):
            pygame.draw.line(self.display, GRID_COLOR, (i, 0), (i, self.h))
        for j in range(0, self.h, BLOCK_SIZE):
            pygame.draw.line(self.display, GRID_COLOR, (0, j), (self.w, j))
    ...
    def _update_ui(self):
        ...
        pygame.draw.circle(self.display, DARK_RED, (self.food.x + BLOCK_SIZE//2, self.food.y + BLOCK_SIZE//2), BLOCK_SIZE//2)
